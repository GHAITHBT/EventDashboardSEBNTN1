...
CREATE TABLE `users` (
  ...
  `role` enum('operator','admin') COLLATE utf8mb4_unicode_ci DEFAULT 'operator',
  PRIMARY KEY (`id`),
...
INSERT INTO `users` VALUES (1,'admin','1234','admin'),(2,'operator','1234','operator');
...
-- Dump completed on 2025-05-12 14:21:08
